...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/elements/titles.vue?vue&type=template&id=5faeeb08&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('main',{staticClass:"main"},[_c('page-header',{attrs:{"subTitle":"Elements","title":"Element Titles","parentUrl":"/elements"}}),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"page-content\">","</div>",[_vm._ssrNode("<div class=\"container\"><section class=\"mt-10 pt-3\"><h2 class=\"title title-center\">Default Style</h2> <p class=\"text-center text-grey\">Sed egestas, ante et vulputate volutpat, eros pede semper est,\n\t\t\t\t\tvitae luctus metus libero eu augue. Morbi purus libero, faucibus adipiscing, commodo quis,\n\t\t\t\t\tgravida id, est. Sed lectus. Praesent elementum hendrerit tortor. Sed semper lorem at felis.\n\t\t\t\t\tVestibulum volutpat, lacus a ultrices sagittis, mi neque euismod dui, eu pulvinar nunc\n\t\t\t\t\tsapien ornare nisl. Phasellus pede arcu, dapibus eu, fermentum et, dapibus sed, urna.</p></section> <section class=\"mt-10 pt-2\"><h2 class=\"title title-simple\">Simple</h2> <p class=\"text-grey\">Donec tellus massa, tristique sit amet condim vel, facilisis quis sapien.\n\t\t\t\t\tPraesent id enim sit amet odio vulputate eleifend in in tortor. ellus massa, tristique sit\n\t\t\t\t\tamet condim vel, facilisuisacilisis quis sapien. Praesent id enim sit amet odio vulputate\n\t\t\t\t\teleifend in in tortor. Donec tellus massa, tristique sit amet condim vel, facilisis quis\n\t\t\t\t\tsapien. Praesent id enim ent id enism sita.sis quis sapi.</p></section> <section class=\"mt-10 pt-2\"><h2 class=\"title title-line\">With Line</h2> <p class=\"text-grey\">Donec tellus massa, tristique sit amet condim vel, facilisis quis sapien.\n\t\t\t\t\tPraesent id enim sit amet odio vulputate eleifend in in tortor. ellus massa, tristique sit\n\t\t\t\t\tamet condim vel, facilisuisacilisis quis sapien. Praesent id enim sit amet odio vulputate\n\t\t\t\t\teleifend in in tortor. Donec tellus massa, tristique sit amet condim vel, facilisis quis\n\t\t\t\t\tsapien. Praesent id enim ent id enism sita.sis quis sapi.</p></section> <section class=\"mt-10 pt-2\"><h2 class=\"title title-line title-underline\"><span>Underline</span></h2> <p class=\"text-grey\">Donec tellus massa, tristique sit amet condim vel, facilisis quis sapien.\n\t\t\t\t\tPraesent id enim sit amet odio vulputate eleifend in in tortor. ellus massa, tristique sit\n\t\t\t\t\tamet condim vel, facilisuisacilisis quis sapien. Praesent id enim sit amet odio vulputate\n\t\t\t\t\teleifend in in tortor. Donec tellus massa, tristique sit amet condim vel, facilisis quis\n\t\t\t\t\tsapien. Praesent id enim ent id enism sita.sis quis sapi.</p></section> <section class=\"mt-10 pt-2\"><h2 class=\"title title-icon title-center mb-3\"><span>Title With Icon</span><i class=\"fa fa-arrow-down\"></i></h2> <p class=\"text-center text-grey\">Sed egestas, ante et vulputate volutpat, eros pede semper est,\n\t\t\t\t\tvitae luctus metus libero eu augue. Morbi purus libero, faucibus adipiscing, commodo quis,\n\t\t\t\t\tgravida id, est. Sed lectus. Praesent elementum hendrerit tortor. Sed semper lorem at felis.\n\t\t\t\t\tVestibulum volutpat, lacus a ultrices sagittis, mi neque euismod dui, eu pulvinar nunc\n\t\t\t\t\tsapien ornare nisl. Phasellus pede arcu, dapibus eu, fermentum et, dapibus sed, urna.</p></section></div> "),_c('element-list',{staticClass:"mt-9"})],2)],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/elements/titles.vue?vue&type=template&id=5faeeb08&
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/elements/titles.vue?vue&type=script&lang=js&
//
//
//
//
...
// CONCATENATED MODULE: ./pages/elements/titles.vue?vue&type=script&lang=js&
 /* harmony default export */ var elements_titlesvue_type_script_lang_js_ = (titlesvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(1);

// CONCATENATED MODULE: ./pages/elements/titles.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  elements_titlesvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var titles = __webpack_exports__["default"] = (component.exports);
