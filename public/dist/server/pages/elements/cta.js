...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/elements/cta.vue?vue&type=template&id=4b64e3da&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('main',{staticClass:"main"},[_c('page-header',{attrs:{"subTitle":"Elements","title":"Element Call To Action","parentUrl":"/elements"}}),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"page-content\">","</div>",[_vm._ssrNode("<section class=\"mt-10 pt-4\">","</section>",[_vm._ssrNode("<div class=\"container\">","</div>",[_vm._ssrNode("<h2 class=\"title title-center mb-5\">Simple</h2> "),_vm._ssrNode("<div class=\"banner cta-simple\">","</div>",[_vm._ssrNode("<div class=\"banner-content bg-white d-lg-flex align-items-center\">","</div>",[_vm._ssrNode("<div class=\"banner-header pr-lg-7 pb-lg-0 pb-4 mb-lg-0 mb-6\"><h3 class=\"banner-title font-weight-bold ls-s text-uppercase\">Trade-in</h3> <h4 class=\"banner-subtitle font-weight-normal ls-s text-body\">Upgrade and save</h4></div> <div class=\"banner-text mb-lg-0 mb-4 mr-lg-4 pl-lg-6 pr-lg-0 pl-2 pr-2\"><h4 class=\"font-weight-normal ls-normal text-uppercase mb-0\">Get a Riode gift\n\t\t\t\t\t\t\t\tcard+25% off</h4> <p class=\"ls-m mb-0\">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do\n\t\t\t\t\t\t\t\teiusmod.</p></div> "),_c('nuxt-link',{staticClass:"btn btn-primary btn-ellipse btn-md btn-rounded",attrs:{"to":"/shop"}},[_vm._v("Shop Now"),_c('i',{staticClass:"d-icon-arrow-right"})])],2)])],2)]),_vm._ssrNode(" "),_vm._ssrNode("<section class=\"mt-10 pt-4\">","</section>",[_vm._ssrNode("<div class=\"container\">","</div>",[_vm._ssrNode("<h2 class=\"title title-center mb-5\">2 Columns</h2> "),_vm._ssrNode("<div class=\"row\">","</div>",[_vm._ssrNode("<div class=\"col-md-6 mb-4\">","</div>",[_vm._ssrNode("<div class=\"banner banner-1 banner-fixed content-center content-middle\">","</div>",[_vm._ssrNode("<figure>","</figure>",[_c('img',{directives:[{name:"lazy",rawName:"v-lazy",value:('./images/cta/1.jpg'),expression:"'./images/cta/1.jpg'"}],attrs:{"alt":"banner","width":"580","height":"330"}},[])]),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"banner-content\">","</div>",[_vm._ssrNode("<h3 class=\"banner-title text-uppercase font-weight-bold ls-m text-primary\">20%\n\t\t\t\t\t\t\t\t\toff</h3> <h4 class=\"banner-subtitle font-weight-bold ls-m text-white\">Riode Birthday\n\t\t\t\t\t\t\t\t\tSale</h4> <p class=\"ls-s text-light\">Get all the latest information on <br>Events, Sales\n\t\t\t\t\t\t\t\t\tand Offers.</p> "),_c('nuxt-link',{staticClass:"btn btn-outline btn-white btn-md btn-rounded",attrs:{"to":"/shop"}},[_vm._v("Discover now")])],2)],2)]),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"col-md-6 mb-4\">","</div>",[_vm._ssrNode("<div class=\"banner banner-2 banner-fixed content-center content-middle\">","</div>",[_vm._ssrNode("<figure>","</figure>",[_c('img',{directives:[{name:"lazy",rawName:"v-lazy",value:('./images/cta/2.jpg'),expression:"'./images/cta/2.jpg'"}],attrs:{"alt":"banner","width":"580","height":"330"}},[])]),_vm._ssrNode(" <div class=\"banner-content\"><h3 class=\"banner-title text-uppercase font-weight-normal ls-m text-white mb-3\">\n\t\t\t\t\t\t\t\t\tSubscribe to our<br><strong>Newsletter</strong></h3> <p class=\"ls-normal text-white\">Start Shopping Right Now</p> <form action=\"#\" method=\"get\" class=\"input-wrapper\"><input type=\"email\" name=\"email\" id=\"email-element\" aria-label=\"element input\" placeholder=\"Enter Your E-mail Address...\" required=\"required\" class=\"form-control w100 text-white text-center mb-4\"> <button type=\"submit\" class=\"btn btn-white btn-md btn-ellipse btn-rounded\">Subscribe<i class=\"d-icon-arrow-right\"></i></button></form></div>")],2)])],2)],2)]),_vm._ssrNode(" "),_vm._ssrNode("<section class=\"mt-9 pt-1\">","</section>",[_vm._ssrNode("<div class=\"container\">","</div>",[_vm._ssrNode("<h2 class=\"title title-center\">3 Columns</h2> "),_vm._ssrNode("<div class=\"banner-group row justify-content-center\">","</div>",[_vm._ssrNode("<div class=\"col-lg-4 col-sm-6 mb-4\">","</div>",[_vm._ssrNode("<div class=\"banner banner-3 banner-fixed banner-radius content-middle\">","</div>",[_vm._ssrNode("<figure>","</figure>",[_c('img',{directives:[{name:"lazy",rawName:"v-lazy",value:('./images/banners/banner1.jpg'),expression:"'./images/banners/banner1.jpg'"}],attrs:{"alt":"banner","width":"380","height":"220"}},[])]),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"banner-content\">","</div>",[_vm._ssrNode("<h3 class=\"banner-title text-white mb-1\">For Men’s</h3> <h4 class=\"banner-subtitle text-uppercase font-weight-normal text-white\">\n\t\t\t\t\t\t\t\t\tStarting at $29\n\t\t\t\t\t\t\t\t</h4> "),_c('nuxt-link',{staticClass:"btn btn-white btn-link btn-underline",attrs:{"to":"/shop"}},[_vm._v("Shop Now"),_c('i',{staticClass:"d-icon-arrow-right"})])],2)],2)]),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"col-lg-4 col-sm-6 mb-4 order-lg-auto order-sm-last\">","</div>",[_vm._ssrNode("<div class=\"banner banner-4 banner-fixed banner-radius content-middle content-center\">","</div>",[_vm._ssrNode("<figure>","</figure>",[_c('img',{directives:[{name:"lazy",rawName:"v-lazy",value:('./images/banners/banner2.jpg'),expression:"'./images/banners/banner2.jpg'"}],attrs:{"alt":"banner","width":"350","height":"177"}},[])]),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"banner-content d-flex align-items-center w-100 text-left\">","</div>",[_vm._ssrNode("<div class=\"mr-auto mb-4 mb-md-0\"><h4 class=\"banner-subtitle text-white mb-0\">\n\t\t\t\t\t\t\t\t\t\tUp to 20% Off<br><span class=\"ls-l\">Black Friday</span></h4> <h3 class=\"banner-title text-primary font-weight-bold lh-1 mb-0\">Sale</h3></div> "),_c('nuxt-link',{staticClass:"btn btn-primary btn-outline font-weight-bold text-white btn-rounded",attrs:{"to":"/shop"}},[_vm._v("Shop\n\t\t\t\t\t\t\t\t\tNow"),_c('i',{staticClass:"d-icon-arrow-right"})])],2)],2)]),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"col-lg-4 col-sm-6 mb-4\">","</div>",[_vm._ssrNode("<div class=\"banner banner-5 banner-fixed banner-radius content-middle\">","</div>",[_vm._ssrNode("<figure>","</figure>",[_c('img',{directives:[{name:"lazy",rawName:"v-lazy",value:('./images/banners/banner3.jpg'),expression:"'./images/banners/banner3.jpg'"}],attrs:{"alt":"banner","width":"380","height":"220"}},[])]),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"banner-content\">","</div>",[_vm._ssrNode("<h3 class=\"banner-title text-white mb-1\">Fashions</h3> <h4 class=\"banner-subtitle text-uppercase font-weight-normal text-white\">30% Off\n\t\t\t\t\t\t\t\t</h4> "),_c('nuxt-link',{staticClass:"btn btn-white btn-link btn-underline",attrs:{"to":"/shop"}},[_vm._v("Shop Now"),_c('i',{staticClass:"d-icon-arrow-right"})])],2)],2)])],2)],2)]),_vm._ssrNode(" <section class=\"mt-10\"><div class=\"container\"><h2 class=\"title title-center\">Expanded Newsletter</h2> <div class=\"banner banner-newsletter\" style=\"background-color: #fff;\"><div class=\"banner-content row gutter-no align-items-center pl-lg-6 pr-lg-6 pl-3 pr-3\"><div class=\"col-xl-5 col-lg-6\"><div class=\"icon-box icon-box-side mb-4 mb-lg-0\"><div class=\"icon-box-icon text-primary\"><i class=\"far fa-envelope\"></i></div> <div class=\"icon-box-content\"><h4 class=\"icon-box-title\">Get Special Offers and Savings</h4> <p class=\"text-dark\">Get all the latest information on Events, Sales and\n\t\t\t\t\t\t\t\t\t\tOffers.</p></div></div></div> <div class=\"col-xl-7 col-lg-6 d-lg-block d-flex justify-content-center\"><form action=\"#\" method=\"get\" class=\"input-wrapper input-wrapper-round input-wrapper-inline ml-lg-auto\"><input type=\"email\" name=\"email\" id=\"email-element-2\" aria-label=\"element input\" placeholder=\"Enter Your E-mail Address...\" required=\"required\" class=\"form-control font-primary font-italic form-solid\"> <button type=\"submit\" class=\"btn btn-dark\">Sign up</button></form></div></div></div></div></section> "),_vm._ssrNode("<section class=\"mt-10 pt-4\">","</section>",[_vm._ssrNode("<div class=\"container\"><h2 class=\"title title-center mb-5\">Expanded on background</h2></div> "),_c('div',{directives:[{name:"parallax",rawName:"v-parallax"}],staticClass:"banner banner-background parallax text-center",staticStyle:{"background-image":"url(images/parallax.jpg)"}},[_vm._ssrNode("<div class=\"container\">","</div>",[_vm._ssrNode("<div class=\"banner-content\">","</div>",[_vm._ssrNode("<h4 class=\"banner-subtitle text-white font-weight-bold ls-l\">\n\t\t\t\t\t\t\tExtra<span class=\"d-inline-block label-star bg-dark text-primary ml-4 mr-2\">30%\n\t\t\t\t\t\t\t\tOff</span>Online\n\t\t\t\t\t\t</h4> <h3 class=\"banner-title font-weight-bold text-white\">Summer Season Sale</h3> <p class=\"text-white ls-s\">Free shipping on orders over $99</p> "),_c('nuxt-link',{staticClass:"btn btn-primary btn-rounded",attrs:{"to":"/shop"}},[_vm._v("Shop Now"),_c('i',{staticClass:"d-icon-arrow-right"})])],2)])])],2),_vm._ssrNode(" "),_c('element-list',{attrs:{"subClass":"pt-4 mt-8"}})],2)],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/elements/cta.vue?vue&type=template&id=4b64e3da&
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/elements/cta.vue?vue&type=script&lang=js&
//
//
//
//
...
// CONCATENATED MODULE: ./pages/elements/cta.vue?vue&type=script&lang=js&
 /* harmony default export */ var elements_ctavue_type_script_lang_js_ = (ctavue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(1);

// CONCATENATED MODULE: ./pages/elements/cta.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  elements_ctavue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
