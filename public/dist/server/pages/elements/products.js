...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/elements/products.vue?vue&type=template&id=6e51a872&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('main',{staticClass:"main"},[_c('page-header',{attrs:{"subTitle":"Elements","title":"Element Products","parentUrl":"/elements"}}),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"page-content\">","</div>",[_vm._ssrNode("<div class=\"container\">","</div>",[_vm._ssrNode("<section class=\"mt-10 pt-8\">","</section>",[_vm._ssrNode("<h2 class=\"title title-center\">Default Style</h2> "),(_vm.products.length > 0)?_vm._ssrNode("<div class=\"row product-wrapper\">","</div>",_vm._l((_vm.products.slice(0,4)),function(item){return _vm._ssrNode("<div class=\"col-md-3 col-6\">","</div>",[_c('product-one',{attrs:{"product":item}})],1)}),0):_vm._ssrNode(("<div class=\"row product-wrapper\">"+(_vm._ssrList(([1,2,3,4]),function(item){return ("<div class=\"col-md-3 col-6\"><div class=\"product-loading-overlay\"></div></div>")}))+"</div>"))],2),_vm._ssrNode(" "),_vm._ssrNode("<section class=\"mt-8\">","</section>",[_vm._ssrNode("<h2 class=\"title title-center\">Centered</h2> "),(_vm.products.length > 0)?_vm._ssrNode("<div class=\"row product-wrapper\">","</div>",_vm._l((_vm.products.slice(0,4)),function(item){return _vm._ssrNode("<div class=\"col-md-3 col-6\">","</div>",[_c('product-two',{staticClass:"text-center",attrs:{"product":item}})],1)}),0):_vm._ssrNode(("<div class=\"row product-wrapper\">"+(_vm._ssrList(([1,2,3,4]),function(item){return ("<div class=\"col-md-3 col-6\"><div class=\"product-loading-overlay\"></div></div>")}))+"</div>"))],2),_vm._ssrNode(" "),_vm._ssrNode("<section class=\"mt-8\">","</section>",[_vm._ssrNode("<h2 class=\"title title-center\">Classic Button</h2> "),(_vm.products.length > 0)?_vm._ssrNode("<div class=\"row product-wrapper\">","</div>",_vm._l((_vm.products.slice(0,4)),function(item){return _vm._ssrNode("<div class=\"col-md-3 col-6\">","</div>",[_c('product-three',{attrs:{"product":item}})],1)}),0):_vm._ssrNode(("<div class=\"row product-wrapper\">"+(_vm._ssrList(([1,2,3,4]),function(item){return ("<div class=\"col-md-3 col-6\"><div class=\"product-loading-overlay\"></div></div>")}))+"</div>"))],2),_vm._ssrNode(" "),_vm._ssrNode("<section class=\"mt-8\">","</section>",[_vm._ssrNode("<h2 class=\"title title-center\">Pop-up</h2> "),(_vm.products.length > 0)?_vm._ssrNode("<div class=\"row product-wrapper\">","</div>",_vm._l((_vm.products.slice(0,4)),function(item){return _vm._ssrNode("<div class=\"col-md-3 col-6\">","</div>",[_c('product-four',{staticClass:"text-center",attrs:{"product":item}})],1)}),0):_vm._ssrNode(("<div class=\"row product-wrapper\">"+(_vm._ssrList(([1,2,3,4]),function(item){return ("<div class=\"col-md-3 col-6\"><div class=\"product-loading-overlay\"></div></div>")}))+"</div>"))],2),_vm._ssrNode(" "),_vm._ssrNode("<section class=\"mt-8\">","</section>",[_vm._ssrNode("<h2 class=\"title title-center\">Split Line 5 Columns</h2> "),(_vm.products.length > 0)?_vm._ssrNode("<div class=\"row product-wrapper split-line\">","</div>",_vm._l((_vm.products.slice(0, 5)),function(item){return _vm._ssrNode("<div class=\"col-xl-5col col-lg-3 col-sm-4 col-6\">","</div>",[_c('product-five',{staticClass:"text-center product-white",attrs:{"product":item}})],1)}),0):_vm._ssrNode(("<div class=\"row product-wrapper split-line\">"+(_vm._ssrList(([1,2,3,4,5]),function(item){return ("<div class=\"col-xl-5col col-lg-3 col-sm-4 col-6\"><div class=\"product-loading-overlay\"></div></div>")}))+"</div>"))],2),_vm._ssrNode(" "),_vm._ssrNode("<section class=\"mt-10\">","</section>",[_vm._ssrNode("<h2 class=\"title title-center\">Without Space</h2> "),(_vm.products.length > 0)?_c('swiper-carousel',{key:"no-space-non-empty",staticClass:"swiper-theme",attrs:{"options":_vm.baseSlider14}},_vm._l((_vm.products.slice(0, 5)),function(item){return _c('product-two',{key:("no-space-type-" + (item.slug)),staticClass:"text-center swiper-slide",attrs:{"product":item}})}),1):_c('swiper-carousel',{key:"no-space-empty",staticClass:"swiper-theme",attrs:{"options":_vm.baseSlider14}},_vm._l(([1,2,3,4,5]),function(item){return _c('div',{key:("no-space-type-skel-" + item),staticClass:"swiper-slide",attrs:{"options":_vm.baseSlider14}},[_c('div',{staticClass:"product-loading-overlay"})])}),0)],2),_vm._ssrNode(" "),_vm._ssrNode("<section class=\"mt-10 pt-2\">","</section>",[_vm._ssrNode("<h2 class=\"title title-center\">Image Gap Style</h2> "),(_vm.products.length > 0)?_vm._ssrNode("<div class=\"row product-wrapper\">","</div>",_vm._l((_vm.products.slice(0,4)),function(item){return _vm._ssrNode("<div class=\"col-md-3 col-6\">","</div>",[_c('product-two',{staticClass:"product-image-gap",attrs:{"product":item}})],1)}),0):_vm._ssrNode(("<div class=\"row product-wrapper\">"+(_vm._ssrList(([1,2,3,4]),function(item){return ("<div class=\"col-md-3 col-6\"><div class=\"product-loading-overlay\"></div></div>")}))+"</div>"))],2),_vm._ssrNode(" "),_vm._ssrNode("<section class=\"mt-10\">","</section>",[_vm._ssrNode("<h2 class=\"title title-center\">Modern Style 1</h2> "),(_vm.products.length > 0)?_c('swiper-carousel',{key:"modern-1-non-empty",staticClass:"swiper-theme",attrs:{"options":_vm.baseSlider15}},_vm._l((_vm.products.slice(0, 5)),function(item){return _c('product-six',{key:("modern-1-type-" + (item.slug)),staticClass:"text-center swiper-slide",attrs:{"product":item}})}),1):_c('swiper-carousel',{staticClass:"swiper-theme",attrs:{"options":_vm.baseSlider15}},_vm._l(([1,2,3,4,5]),function(item){return _c('div',{key:("modern-1-type-skel-" + item),staticClass:"swiper-slide"},[_c('div',{staticClass:"product-loading-overlay"})])}),0)],2),_vm._ssrNode(" "),_vm._ssrNode("<section class=\"mt-10 pb-4\">","</section>",[_vm._ssrNode("<h2 class=\"title title-center\">Modern Style 2</h2> "),(_vm.products.length > 0)?_c('swiper-carousel',{key:"modern-2-non-empty",staticClass:"swiper-theme",attrs:{"options":_vm.baseSlider15}},_vm._l((_vm.products.slice(0, 5)),function(item){return _c('product-seven',{key:("modern-2-type-" + (item.slug)),staticClass:"text-center swiper-slide",attrs:{"product":item}})}),1):_c('swiper-carousel',{staticClass:"swiper-theme",attrs:{"options":_vm.baseSlider15}},_vm._l(([1,2,3,4,5]),function(item){return _c('div',{key:("modern-2-type-skel-" + item),staticClass:"swiper-slide"},[_c('div',{staticClass:"product-loading-overlay"})])}),0)],2),_vm._ssrNode(" "),_vm._ssrNode("<section class=\"mt-8\">","</section>",[_vm._ssrNode("<h2 class=\"title title-center\">Products List</h2> "),_vm._ssrNode("<div class=\"row\">","</div>",[_vm._ssrNode("<div class=\"col-lg-9\">","</div>",[(_vm.products.length > 0)?_vm._l((_vm.products.slice(0,2)),function(item){return _c('product-eight',{key:("list-type-" + (item.slug)),attrs:{"product":item}})}):_vm._ssrNode((_vm._ssrList(([1,2]),function(item){return ("<div class=\"col-md-3 col-6\"><div class=\"product-loading-overlay\"></div></div>")})))],2),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"col-lg-3\">","</div>",[_vm._ssrNode("<div class=\"widget widget-products\">","</div>",[_vm._ssrNode("<h4 class=\"widget-title\">Our Featured</h4> "),_vm._ssrNode("<div class=\"widget-body\">","</div>",[(_vm.products.length > 0)?[_c('swiper-carousel',{staticClass:"swiper-nav-top",attrs:{"options":_vm.baseSlider4}},[_c('div',{staticClass:"products-col swiper-slide"},_vm._l((_vm.products.slice(0,4)),function(item){return _c('product-small',{key:("product-small-" + (item.slug)),attrs:{"product":item}})}),1),_vm._v(" "),_c('div',{staticClass:"products-col swiper-slide"},_vm._l((_vm.products.slice(4,8)),function(item){return _c('product-small',{key:("product-small-" + (item.slug)),attrs:{"product":item}})}),1)])]:_vm._e()],2)],2)])],2)],2)],2),_vm._ssrNode(" "),_c('element-list',{staticClass:"mt-8"})],2)],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/elements/products.vue?vue&type=template&id=6e51a872&
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib??vue-loader-options!./components/elements/product/ProductOne.vue?vue&type=script&lang=js&
//
//
//
//
...
/* harmony default export */ var ProductOnevue_type_script_lang_js_ = ({
  ...
  methods: { ...Object(external_vuex_["mapActions"])('cart', ['addToCart']),
    ...
    openQuickview: function () {
      this.$modal.show(() => __webpack_require__.e(/* import() */ 0).then(__webpack_require__.bind(null, 108)), {
...
// CONCATENATED MODULE: ./components/elements/product/ProductOne.vue?vue&type=script&lang=js&
...
// CONCATENATED MODULE: ./components/elements/product/ProductOne.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  ...
  ProductOnevue_type_template_id_6cced752_render,
  ProductOnevue_type_template_id_6cced752_staticRenderFns,
  false,
  null,
  null,
  "2f721dba"
...
/* harmony default export */ var ProductThreevue_type_script_lang_js_ = ({
  props: {
    product: Object
  },
  data: function () {
...
// CONCATENATED MODULE: ./components/elements/product/ProductThree.vue?vue&type=script&lang=js&
 /* harmony default export */ var product_ProductThreevue_type_script_lang_js_ = (ProductThreevue_type_script_lang_js_); 
// CONCATENATED MODULE: ./components/elements/product/ProductThree.vue
...
var ProductThree_component = Object(componentNormalizer["a" /* default */])(
  product_ProductThreevue_type_script_lang_js_,
  ProductThreevue_type_template_id_af423e58_render,
  ProductThreevue_type_template_id_af423e58_staticRenderFns,
  false,
  null,
  null,
  "74da571b"
...
/* harmony default export */ var ProductThree = (ProductThree_component.exports);
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./components/elements/product/ProductFour.vue?vue&type=template&id=8c987746&
var ProductFourvue_type_template_id_8c987746_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"product product-slideup-content text-center product-variable",class:{'product-variable': _vm.product.variants.length > 0},on:{"mouseenter":_vm.showDetail,"mouseleave":_vm.hideDetail,"touchstart":_vm.showDetail,"touchleave":_vm.showDetail}},[_vm._ssrNode("<figure class=\"product-media\">","</figure>",[_c('nuxt-link',{attrs:{"to":("/product/default/" + (_vm.product.slug))}},_vm._l((_vm.product.large_pictures.slice(0,2)),function(item,index){return _c('img',{directives:[{name:"lazy",rawName:"v-lazy",value:(("" + _vm.baseUrl + (item.url))),expression:"`${baseUrl}${item.url}`"}],key:("one-large-" + index),class:{'last-image': index === 1},attrs:{"alt":"large-picture","width":item.width,"height":item.height}})}),0),_vm._ssrNode(" <div class=\"product-label-group\">"+((_vm.product.is_new)?("<div class=\"product-label label-new\">New</div>"):"<!---->")+" "+((_vm.product.stock === '0')?("<div class=\"product-label label-stock\">Out</div>"):"<!---->")+" "+((_vm.product.is_top)?("<div class=\"product-label label-top\">Top</div>"):"<!---->")+" "+((_vm.product.discount > 0)?("<div class=\"product-label label-sale\">"+((_vm.product.variants.length > 0)?("Sale"):(_vm._ssrEscape("-"+_vm._s(_vm.product.discount)+"%")))+"</div>"):"<!---->")+"</div>")],2),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"product-details\">","</div>",[_vm._ssrNode("<div class=\"product-cat\">","</div>",_vm._l((_vm.product.product_categories),function(cat,index){return _vm._ssrNode("<span>","</span>",[_c('nuxt-link',{attrs:{"to":{ path: '/shop', query: { category: cat.slug }}}},[_vm._v(_vm._s(cat.name))]),_vm._ssrNode(" "+((index < _vm.product.product_categories.length - 1)?(","):"<!---->"))],2)}),0),_vm._ssrNode(" "),_vm._ssrNode("<h3 class=\"product-name\">","</h3>",[_c('nuxt-link',{attrs:{"to":'/product/default/' + _vm.product.slug}},[_vm._v(_vm._s(_vm.product.name))])],1),_vm._ssrNode(" <div class=\"product-price\">"+((_vm.product.display_price[ 0 ] === _vm.product.display_price[ 1 ])?("<span class=\"price\">"+_vm._ssrEscape("$"+_vm._s(_vm._f("priceFormat")(_vm.product.display_price[0])))+"</span>"):(((_vm.product.variants.length === 0 || (_vm.product.variants.length > 0 && !_vm.product.variants[0].price))?("<ins class=\"new-price\">"+_vm._ssrEscape("$"+_vm._s(_vm._f("priceFormat")(_vm.product.display_price[0])))+"</ins> <del class=\"old-price\">"+_vm._ssrEscape("$"+_vm._s(_vm._f("priceFormat")(_vm.product.display_price[1])))+"</del>"):("<ins class=\"new-price\">"+_vm._ssrEscape("$"+_vm._s(_vm._f("priceFormat")(_vm.product.display_price[0]))+" – $"+_vm._s(_vm._f("priceFormat")(_vm.product.display_price[1])))+"</ins>"))))+"</div>")],2),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"product-hide-details\">","</div>",[_vm._ssrNode("<div class=\"ratings-container\"><div class=\"ratings-full\"><span class=\"ratings\""+(_vm._ssrStyle(null,{width: _vm.product.ratings * 20 + '%'}, null))+"></span> <span class=\"tooltiptext tooltip-top\">"+_vm._ssrEscape(_vm._s(_vm._f("priceFormat")(_vm.product.ratings)))+"</span></div> <a href=\"javascript:;\" class=\"rating-reviews\">"+_vm._ssrEscape("( "+_vm._s(_vm.product.reviews)+" reviews )")+"</a></div> "),_vm._ssrNode("<div class=\"product-action\">","</div>",[_vm._ssrNode(((!_vm.isWishlisted)?("<a href=\"javascript:;\" title=\"Add to wishlist\" class=\"btn-wishlist btn-product-icon\"><i class=\"d-icon-heart\"></i></a>"):"<!---->")+" "+((_vm.isWishlisted)?("<a href=\"javascript:;\" title=\"Remove from wishlist\" class=\"btn-wishlist btn-product-icon\"><i class=\"d-icon-heart-full\"></i></a>"):"<!---->")+" "),(_vm.product.variants.length === 0)?_vm._ssrNode("<a href=\"javascript:;\" title=\"Add to cart\" class=\"btn-product btn-cart\">","</a>",[_vm._ssrNode("<i class=\"d-icon-bag\"></i><span>Add to cart</span>")],2):_c('nuxt-link',{staticClass:"btn-product btn-cart",attrs:{"to":("/product/default/" + (_vm.product.slug)),"title":"Go to detail"}},[_c('span',[_vm._v("Select Options")])]),_vm._ssrNode(" <a href=\"javascript:;\" title=\"Quick View\" class=\"btn-product-icon btn-quickview\"><i class=\"d-icon-search\"></i></a>")],2)],2)],2)}
var ProductFourvue_type_template_id_8c987746_staticRenderFns = []


// CONCATENATED MODULE: ./components/elements/product/ProductFour.vue?vue&type=template&id=8c987746&

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib??vue-loader-options!./components/elements/product/ProductFour.vue?vue&type=script&lang=js&
//
//
//
//
...
/* harmony default export */ var ProductFourvue_type_script_lang_js_ = ({
  props: {
    product: Object
  },
  data: function () {
...
// CONCATENATED MODULE: ./components/elements/product/ProductFour.vue?vue&type=script&lang=js&
 /* harmony default export */ var product_ProductFourvue_type_script_lang_js_ = (ProductFourvue_type_script_lang_js_); 
// CONCATENATED MODULE: ./components/elements/product/ProductFour.vue
...
var ProductFour_component = Object(componentNormalizer["a" /* default */])(
  product_ProductFourvue_type_script_lang_js_,
  ProductFourvue_type_template_id_8c987746_render,
  ProductFourvue_type_template_id_8c987746_staticRenderFns,
  false,
  null,
  null,
  "6504238e"
...
/* harmony default export */ var ProductFour = (ProductFour_component.exports);
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./components/elements/product/ProductFive.vue?vue&type=template&id=e443a052&
var ProductFivevue_type_template_id_e443a052_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"product product-slideup",class:{'product-variable': _vm.product.variants.length > 0}},[_vm._ssrNode("<figure class=\"product-media\">","</figure>",[_c('nuxt-link',{attrs:{"to":("/product/default/" + (_vm.product.slug))}},_vm._l((_vm.product.large_pictures.slice(0,2)),function(item,index){return _c('img',{directives:[{name:"lazy",rawName:"v-lazy",value:(("" + _vm.baseUrl + (item.url))),expression:"`${baseUrl}${item.url}`"}],key:("one-large-" + index),class:{'last-image': index === 1},attrs:{"alt":"large-picture","width":item.width,"height":item.height}})}),0),_vm._ssrNode(" <div class=\"product-label-group\">"+((_vm.product.is_new)?("<div class=\"product-label label-new\">New</div>"):"<!---->")+" "+((_vm.product.stock === '0')?("<div class=\"product-label label-stock\">Out</div>"):"<!---->")+" "+((_vm.product.is_top)?("<div class=\"product-label label-top\">Top</div>"):"<!---->")+" "+((_vm.product.discount > 0)?("<div class=\"product-label label-sale\">"+((_vm.product.variants.length > 0)?("Sale"):(_vm._ssrEscape("-"+_vm._s(_vm.product.discount)+"%")))+"</div>"):"<!---->")+"</div>")],2),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"product-details\">","</div>",[_vm._ssrNode("<div class=\"product-cat\">","</div>",_vm._l((_vm.product.product_categories),function(cat,index){return _vm._ssrNode("<span>","</span>",[_c('nuxt-link',{attrs:{"to":{ path: '/shop', query: { category: cat.slug }}}},[_vm._v(_vm._s(cat.name))]),_vm._ssrNode(" "+((index < _vm.product.product_categories.length - 1)?(","):"<!---->"))],2)}),0),_vm._ssrNode(" "),_vm._ssrNode("<h3 class=\"product-name\">","</h3>",[_c('nuxt-link',{attrs:{"to":'/product/default/' + _vm.product.slug}},[_vm._v(_vm._s(_vm.product.name))])],1),_vm._ssrNode(" <div class=\"product-price\">"+((_vm.product.display_price[ 0 ] === _vm.product.display_price[ 1 ])?("<span class=\"price\">"+_vm._ssrEscape("$"+_vm._s(_vm._f("priceFormat")(_vm.product.display_price[0])))+"</span>"):(((_vm.product.variants.length === 0 || (_vm.product.variants.length > 0 && !_vm.product.variants[0].price))?("<ins class=\"new-price\">"+_vm._ssrEscape("$"+_vm._s(_vm._f("priceFormat")(_vm.product.display_price[0])))+"</ins> <del class=\"old-price\">"+_vm._ssrEscape("$"+_vm._s(_vm._f("priceFormat")(_vm.product.display_price[1])))+"</del>"):("<ins class=\"new-price\">"+_vm._ssrEscape("$"+_vm._s(_vm._f("priceFormat")(_vm.product.display_price[0]))+" – $"+_vm._s(_vm._f("priceFormat")(_vm.product.display_price[1])))+"</ins>"))))+"</div>")],2),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"product-hide-details\">","</div>",[_vm._ssrNode("<div class=\"ratings-container\"><div class=\"ratings-full\"><span class=\"ratings\""+(_vm._ssrStyle(null,{width: _vm.product.ratings * 20 + '%'}, null))+"></span> <span class=\"tooltiptext tooltip-top\">"+_vm._ssrEscape(_vm._s(_vm._f("priceFormat")(_vm.product.ratings)))+"</span></div> <a href=\"javascript:;\" class=\"rating-reviews\">"+_vm._ssrEscape("( "+_vm._s(_vm.product.reviews)+" reviews )")+"</a></div> "),_vm._ssrNode("<div class=\"product-action\">","</div>",[_vm._ssrNode(((!_vm.isWishlisted)?("<a href=\"javascript:;\" title=\"Add to wishlist\" class=\"btn-wishlist btn-product-icon\"><i class=\"d-icon-heart\"></i></a>"):"<!---->")+" "+((_vm.isWishlisted)?("<a href=\"javascript:;\" title=\"Remove from wishlist\" class=\"btn-wishlist btn-product-icon\"><i class=\"d-icon-heart-full\"></i></a>"):"<!---->")+" "),(_vm.product.variants.length === 0)?_vm._ssrNode("<a href=\"javascript:;\" title=\"Add to cart\" class=\"btn-product btn-cart\">","</a>",[_vm._ssrNode("<i class=\"d-icon-bag\"></i><span>Add to cart</span>")],2):_c('nuxt-link',{staticClass:"btn-product btn-cart",attrs:{"to":("/product/default/" + (_vm.product.slug)),"title":"Go to detail"}},[_c('span',[_vm._v("Select Options")])]),_vm._ssrNode(" <a href=\"javascript:;\" title=\"Quick View\" class=\"btn-product-icon btn-quickview\"><i class=\"d-icon-search\"></i></a>")],2)],2)],2)}
var ProductFivevue_type_template_id_e443a052_staticRenderFns = []


// CONCATENATED MODULE: ./components/elements/product/ProductFive.vue?vue&type=template&id=e443a052&

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib??vue-loader-options!./components/elements/product/ProductFive.vue?vue&type=script&lang=js&
//
//
//
//
...
/* harmony default export */ var ProductFivevue_type_script_lang_js_ = ({
  props: {
    product: Object
  },
  data: function () {
...
// CONCATENATED MODULE: ./components/elements/product/ProductFive.vue?vue&type=script&lang=js&
 /* harmony default export */ var product_ProductFivevue_type_script_lang_js_ = (ProductFivevue_type_script_lang_js_); 
// CONCATENATED MODULE: ./components/elements/product/ProductFive.vue
...
var ProductFive_component = Object(componentNormalizer["a" /* default */])(
  product_ProductFivevue_type_script_lang_js_,
  ProductFivevue_type_template_id_e443a052_render,
  ProductFivevue_type_template_id_e443a052_staticRenderFns,
  false,
  null,
  null,
  "ddd39c76"
...
/* harmony default export */ var ProductFive = (ProductFive_component.exports);
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./components/elements/product/ProductSix.vue?vue&type=template&id=2692afa8&
var ProductSixvue_type_template_id_2692afa8_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"product product-variable shadow-media cart-full",class:{'product-variable': _vm.product.variants.length > 0}},[_vm._ssrNode("<figure class=\"product-media\">","</figure>",[_c('nuxt-link',{attrs:{"to":("/product/default/" + (_vm.product.slug))}},_vm._l((_vm.product.large_pictures.slice(0,2)),function(item,index){return _c('img',{directives:[{name:"lazy",rawName:"v-lazy",value:(("" + _vm.baseUrl + (item.url))),expression:"`${baseUrl}${item.url}`"}],key:("one-large-" + index),class:{'last-image': index === 1},attrs:{"alt":"large-picture","width":item.width,"height":item.height}})}),0),_vm._ssrNode(" <div class=\"product-label-group\">"+((_vm.product.is_new)?("<div class=\"product-label label-new\">New</div>"):"<!---->")+" "+((_vm.product.stock === '0')?("<div class=\"product-label label-stock\">Out</div>"):"<!---->")+" "+((_vm.product.is_top)?("<div class=\"product-label label-top\">Top</div>"):"<!---->")+" "+((_vm.product.discount > 0)?("<div class=\"product-label label-sale\">"+((_vm.product.variants.length > 0)?("Sale"):(_vm._ssrEscape("-"+_vm._s(_vm.product.discount)+"%")))+"</div>"):"<!---->")+"</div> <div class=\"product-action-vertical\">"+((!_vm.isWishlisted)?("<a href=\"javascript:;\" title=\"Add to wishlist\" class=\"btn-wishlist btn-product-icon\"><i class=\"d-icon-heart\"></i></a>"):"<!---->")+" "+((_vm.isWishlisted)?("<a href=\"javascript:;\" title=\"Remove from wishlist\" class=\"btn-wishlist btn-product-icon\"><i class=\"d-icon-heart-full\"></i></a>"):"<!---->")+"</div> <div class=\"product-action\"><a href=\"javascript:;\" title=\"Quick View\" class=\"btn-product btn-quickview\">Quick View</a></div>")],2),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"product-details\">","</div>",[_vm._ssrNode("<div class=\"product-cat\">","</div>",_vm._l((_vm.product.product_categories),function(cat,index){return _vm._ssrNode("<span>","</span>",[_c('nuxt-link',{attrs:{"to":{ path: '/shop', query: { category: cat.slug }}}},[_vm._v(_vm._s(cat.name))]),_vm._ssrNode(" "+((index < _vm.product.product_categories.length - 1)?(","):"<!---->"))],2)}),0),_vm._ssrNode(" "),_vm._ssrNode("<h3 class=\"product-name\">","</h3>",[_c('nuxt-link',{attrs:{"to":'/product/default/' + _vm.product.slug}},[_vm._v(_vm._s(_vm.product.name))])],1),_vm._ssrNode(" <div class=\"product-price\">"+((_vm.product.display_price[ 0 ] === _vm.product.display_price[ 1 ])?("<span class=\"price\">"+_vm._ssrEscape("$"+_vm._s(_vm._f("priceFormat")(_vm.product.display_price[0])))+"</span>"):(((_vm.product.variants.length === 0 || (_vm.product.variants.length > 0 && !_vm.product.variants[0].price))?("<ins class=\"new-price\">"+_vm._ssrEscape("$"+_vm._s(_vm._f("priceFormat")(_vm.product.display_price[0])))+"</ins> <del class=\"old-price\">"+_vm._ssrEscape("$"+_vm._s(_vm._f("priceFormat")(_vm.product.display_price[1])))+"</del>"):("<ins class=\"new-price\">"+_vm._ssrEscape("$"+_vm._s(_vm._f("priceFormat")(_vm.product.display_price[0]))+" – $"+_vm._s(_vm._f("priceFormat")(_vm.product.display_price[1])))+"</ins>"))))+"</div> <div class=\"ratings-container\"><div class=\"ratings-full\"><span class=\"ratings\""+(_vm._ssrStyle(null,{width: _vm.product.ratings * 20 + '%'}, null))+"></span> <span class=\"tooltiptext tooltip-top\">"+_vm._ssrEscape(_vm._s(_vm._f("priceFormat")(_vm.product.ratings)))+"</span></div> <a href=\"javascript:;\" class=\"rating-reviews\">"+_vm._ssrEscape("( "+_vm._s(_vm.product.reviews)+" reviews )")+"</a></div> "),(_vm.product.variants.length === 0)?_vm._ssrNode("<a href=\"javascript:;\" title=\"Add to cart\" class=\"btn-product btn-cart\">","</a>",[_vm._ssrNode("<i class=\"d-icon-bag\"></i><span>Add to Cart</span>")],2):_c('nuxt-link',{staticClass:"btn-product btn-cart",attrs:{"to":("/product/default/" + (_vm.product.slug)),"title":"Go to detail"}},[_c('span',[_vm._v("Select Options")])])],2)],2)}
var ProductSixvue_type_template_id_2692afa8_staticRenderFns = []


// CONCATENATED MODULE: ./components/elements/product/ProductSix.vue?vue&type=template&id=2692afa8&

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib??vue-loader-options!./components/elements/product/ProductSix.vue?vue&type=script&lang=js&
//
//
//
//
...
/* harmony default export */ var ProductSixvue_type_script_lang_js_ = ({
  props: {
    product: Object
  },
  data: function () {
...
// CONCATENATED MODULE: ./components/elements/product/ProductSix.vue?vue&type=script&lang=js&
 /* harmony default export */ var product_ProductSixvue_type_script_lang_js_ = (ProductSixvue_type_script_lang_js_); 
// CONCATENATED MODULE: ./components/elements/product/ProductSix.vue
...
var ProductSix_component = Object(componentNormalizer["a" /* default */])(
  product_ProductSixvue_type_script_lang_js_,
  ProductSixvue_type_template_id_2692afa8_render,
  ProductSixvue_type_template_id_2692afa8_staticRenderFns,
  false,
  null,
  null,
  "97393cc2"
...
/* harmony default export */ var ProductSix = (ProductSix_component.exports);
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./components/elements/product/ProductSeven.vue?vue&type=template&id=d17561fe&
var ProductSevenvue_type_template_id_d17561fe_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"product shadow-media product-with-qty",class:{'product-variable': _vm.product.variants.length > 0}},[_vm._ssrNode("<figure class=\"product-media\">","</figure>",[_c('nuxt-link',{attrs:{"to":("/product/default/" + (_vm.product.slug))}},_vm._l((_vm.product.large_pictures.slice(0,2)),function(item,index){return _c('img',{directives:[{name:"lazy",rawName:"v-lazy",value:(("" + _vm.baseUrl + (item.url))),expression:"`${baseUrl}${item.url}`"}],key:("one-large-" + index),class:{'last-image': index === 1},attrs:{"alt":"large-picture","width":item.width,"height":item.height}})}),0),_vm._ssrNode(" <div class=\"product-label-group\">"+((_vm.product.is_new)?("<div class=\"product-label label-new\">New</div>"):"<!---->")+" "+((_vm.product.stock === '0')?("<div class=\"product-label label-stock\">Out</div>"):"<!---->")+" "+((_vm.product.is_top)?("<div class=\"product-label label-top\">Top</div>"):"<!---->")+" "+((_vm.product.discount > 0)?("<div class=\"product-label label-sale\">"+((_vm.product.variants.length > 0)?("Sale"):(_vm._ssrEscape("-"+_vm._s(_vm.product.discount)+"%")))+"</div>"):"<!---->")+"</div> <div class=\"product-action-vertical\">"+((!_vm.isWishlisted)?("<a href=\"javascript:;\" title=\"Add to wishlist\" class=\"btn-wishlist btn-product-icon\"><i class=\"d-icon-heart\"></i></a>"):"<!---->")+" "+((_vm.isWishlisted)?("<a href=\"javascript:;\" title=\"Remove from wishlist\" class=\"btn-wishlist btn-product-icon\"><i class=\"d-icon-heart-full\"></i></a>"):"<!---->")+"</div> <div class=\"product-action\"><a href=\"javascript:;\" title=\"Quick View\" class=\"btn-product btn-quickview\">Quick View</a></div>")],2),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"product-details\">","</div>",[_vm._ssrNode("<div class=\"product-cat\">","</div>",_vm._l((_vm.product.product_categories),function(cat,index){return _vm._ssrNode("<span>","</span>",[_c('nuxt-link',{attrs:{"to":{ path: '/shop', query: { category: cat.slug }}}},[_vm._v(_vm._s(cat.name))]),_vm._ssrNode(" "+((index < _vm.product.product_categories.length - 1)?(","):"<!---->"))],2)}),0),_vm._ssrNode(" "),_vm._ssrNode("<h3 class=\"product-name\">","</h3>",[_c('nuxt-link',{attrs:{"to":'/product/default/' + _vm.product.slug}},[_vm._v(_vm._s(_vm.product.name))])],1),_vm._ssrNode(" <div class=\"product-price\">"+((_vm.product.display_price[ 0 ] === _vm.product.display_price[ 1 ])?("<span class=\"price\">"+_vm._ssrEscape("$"+_vm._s(_vm._f("priceFormat")(_vm.product.display_price[0])))+"</span>"):(((_vm.product.variants.length === 0 || (_vm.product.variants.length > 0 && !_vm.product.variants[0].price))?("<ins class=\"new-price\">"+_vm._ssrEscape("$"+_vm._s(_vm._f("priceFormat")(_vm.product.display_price[0])))+"</ins> <del class=\"old-price\">"+_vm._ssrEscape("$"+_vm._s(_vm._f("priceFormat")(_vm.product.display_price[1])))+"</del>"):("<ins class=\"new-price\">"+_vm._ssrEscape("$"+_vm._s(_vm._f("priceFormat")(_vm.product.display_price[0]))+" – $"+_vm._s(_vm._f("priceFormat")(_vm.product.display_price[1])))+"</ins>"))))+"</div> "),_vm._ssrNode("<div class=\"product-action\">","</div>",[(_vm.product.variants.length === 0)?_c('input-quantity',{attrs:{"max":_vm.product.stock,"defaultClass":"product-quantity"},on:{"change-qty":_vm.changeQty}}):_vm._e(),_vm._ssrNode(" "),(_vm.product.variants.length === 0)?_vm._ssrNode("<a href=\"javascript:;\" title=\"Add to cart\" class=\"btn-product btn-cart\">","</a>",[_vm._ssrNode("<i class=\"d-icon-bag\"></i><span>Add to Cart</span>")],2):_c('nuxt-link',{staticClass:"btn-product btn-cart",attrs:{"to":("/product/default/" + (_vm.product.slug)),"title":"Go to detail"}},[_c('span',[_vm._v("Select Options")])])],2)],2)],2)}
var ProductSevenvue_type_template_id_d17561fe_staticRenderFns = []


// CONCATENATED MODULE: ./components/elements/product/ProductSeven.vue?vue&type=template&id=d17561fe&

// EXTERNAL MODULE: ./components/elements/InputQuantity.vue + 4 modules
var InputQuantity = __webpack_require__(77);

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib??vue-loader-options!./components/elements/product/ProductSeven.vue?vue&type=script&lang=js&
//
//
//
//
...
/* harmony default export */ var ProductSevenvue_type_script_lang_js_ = ({
  components: {
...
// CONCATENATED MODULE: ./components/elements/product/ProductSeven.vue?vue&type=script&lang=js&
 /* harmony default export */ var product_ProductSevenvue_type_script_lang_js_ = (ProductSevenvue_type_script_lang_js_); 
// CONCATENATED MODULE: ./components/elements/product/ProductSeven.vue
...
var ProductSeven_component = Object(componentNormalizer["a" /* default */])(
  product_ProductSevenvue_type_script_lang_js_,
  ProductSevenvue_type_template_id_d17561fe_render,
  ProductSevenvue_type_template_id_d17561fe_staticRenderFns,
  false,
  null,
  null,
  "7d0a220a"
...
/* harmony default export */ var ProductSeven = (ProductSeven_component.exports);
// EXTERNAL MODULE: ./components/elements/product/ProductEight.vue + 4 modules
var ProductEight = __webpack_require__(84);

// EXTERNAL MODULE: ./components/elements/product/ProductSmall.vue + 4 modules
var ProductSmall = __webpack_require__(93);
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/elements/products.vue?vue&type=script&lang=js&
//
//
//
//
...
/* harmony default export */ var productsvue_type_script_lang_js_ = ({
  components: {
    ...
    ProductSmall: ProductSmall["a" /* default */]
  },
  data: function () {
    return {
      products: [],
      baseSlider4: carousel["m" /* baseSlider4 */],
      baseSlider14: carousel["f" /* baseSlider14 */],
      baseSlider15: carousel["g" /* baseSlider15 */]
    };
  },
  mounted: function () {
    api["c" /* default */].get(`${api["a" /* baseUrl */]}/demo-${api["b" /* currentDemo */]}`, {
      params: {
        is_product: true,
        is_post: false,
        limit: 8
...
// CONCATENATED MODULE: ./pages/elements/products.vue?vue&type=script&lang=js&
 /* harmony default export */ var elements_productsvue_type_script_lang_js_ = (productsvue_type_script_lang_js_); 
// CONCATENATED MODULE: ./pages/elements/products.vue
...
var products_component = Object(componentNormalizer["a" /* default */])(
  elements_productsvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./components/elements/product/ProductSmall.vue?vue&type=template&id=150314f6&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"product product-list-sm"},[_vm._ssrNode("<figure class=\"product-media\">","</figure>",[_c('nuxt-link',{attrs:{"to":("/product/default/" + (_vm.product.slug))}},_vm._l((_vm.product.large_pictures.slice(0,2)),function(item,index){return _c('img',{directives:[{name:"lazy",rawName:"v-lazy",value:(("" + _vm.baseUrl + (item.url))),expression:"`${baseUrl}${item.url}`"}],key:("one-large-" + index),class:{'last-image': index === 1},attrs:{"alt":"large-picture","width":item.width,"height":item.height}})}),0)],1),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"product-details\">","</div>",[_vm._ssrNode("<h3 class=\"product-name\">","</h3>",[_c('nuxt-link',{attrs:{"to":'/product/default/' + _vm.product.slug}},[_vm._v(_vm._s(_vm.product.name))])],1),_vm._ssrNode(" <div class=\"product-price\">"+((_vm.product.display_price[ 0 ] === _vm.product.display_price[ 1 ])?("<span class=\"price\">"+_vm._ssrEscape("$"+_vm._s(_vm._f("priceFormat")(_vm.product.display_price[0])))+"</span>"):(((_vm.product.variants.length === 0 || (_vm.product.variants.length > 0 && !_vm.product.variants[0].price))?("<ins class=\"new-price\">"+_vm._ssrEscape("$"+_vm._s(_vm._f("priceFormat")(_vm.product.display_price[0])))+"</ins> <del class=\"old-price\">"+_vm._ssrEscape("$"+_vm._s(_vm._f("priceFormat")(_vm.product.display_price[1])))+"</del>"):("<ins class=\"new-price\">"+_vm._ssrEscape("$"+_vm._s(_vm._f("priceFormat")(_vm.product.display_price[0]))+" – $"+_vm._s(_vm._f("priceFormat")(_vm.product.display_price[1])))+"</ins>"))))+"</div> <div class=\"ratings-container\"><div class=\"ratings-full\"><span class=\"ratings\""+(_vm._ssrStyle(null,{width: _vm.product.ratings * 20 + '%'}, null))+"></span> <span class=\"tooltiptext tooltip-top\">"+_vm._ssrEscape(_vm._s(_vm._f("priceFormat")(_vm.product.ratings)))+"</span></div> <a href=\"javascript:;\" class=\"rating-reviews\">"+_vm._ssrEscape("( "+_vm._s(_vm.product.reviews)+" reviews )")+"</a></div>")],2)],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./components/elements/product/ProductSmall.vue?vue&type=template&id=150314f6&

// EXTERNAL MODULE: ./api/index.js
var api = __webpack_require__(2);

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib??vue-loader-options!./components/elements/product/ProductSmall.vue?vue&type=script&lang=js&
//
//
//
//
...
/* harmony default export */ var ProductSmallvue_type_script_lang_js_ = ({
  props: {
    product: Object
  },
  data: function () {
...
// CONCATENATED MODULE: ./components/elements/product/ProductSmall.vue?vue&type=script&lang=js&
 /* harmony default export */ var product_ProductSmallvue_type_script_lang_js_ = (ProductSmallvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(1);

// CONCATENATED MODULE: ./components/elements/product/ProductSmall.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  product_ProductSmallvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var ProductSmall = __webpack_exports__["a"] = (component.exports);
