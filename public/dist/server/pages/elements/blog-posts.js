...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/elements/blog-posts.vue?vue&type=template&id=c4242b00&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('main',{staticClass:"main"},[_c('page-header',{attrs:{"subTitle":"Elements","title":"Element Blog","parentUrl":"/elements"}}),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"page-content\">","</div>",[_vm._ssrNode("<section class=\"mt-10 pt-4 pb-10\">","</section>",[_vm._ssrNode("<div class=\"container\">","</div>",[_vm._ssrNode("<h2 class=\"title title-center\">Default</h2> "),(_vm.posts.length > 0)?_c('swiper-carousel',{staticClass:"swiper-theme",attrs:{"options":_vm.baseSlider10}},_vm._l((_vm.posts.slice(0,3)),function(item){return _c('div',{key:("post-one-" + (item.slug)),staticClass:"swiper-slide"},[_c('post-one',{staticClass:"text-center",attrs:{"post":item,"overlay-class":"overlay-zoom overlay-dark"}})],1)}),0):_vm._e()],2)]),_vm._ssrNode(" "),_vm._ssrNode("<section class=\"grey-section pt-10 pb-10\">","</section>",[_vm._ssrNode("<div class=\"container mt-4\">","</div>",[_vm._ssrNode("<h2 class=\"title title-center\">List</h2> "),(_vm.posts.length > 0)?_c('swiper-carousel',{staticClass:"swiper-theme",attrs:{"options":_vm.baseSlider12}},_vm._l((_vm.posts.slice(0,2)),function(item){return _c('div',{key:("post-two-" + (item.slug)),staticClass:"swiper-slide"},[_c('post-two',{attrs:{"post":item}})],1)}),0):_vm._e()],2)]),_vm._ssrNode(" "),_vm._ssrNode("<section class=\"mt-10 pt-4 pb-10\">","</section>",[_vm._ssrNode("<div class=\"container\">","</div>",[_vm._ssrNode("<h2 class=\"title title-center\">Without description</h2> "),(_vm.posts.length > 0)?_c('swiper-carousel',{staticClass:"swiper-theme",attrs:{"options":_vm.baseSlider10}},_vm._l((_vm.posts.slice(0,3)),function(item){return _c('div',{key:("post-three-" + (item.slug)),staticClass:"swiper-slide"},[_c('post-three',{staticClass:"post-sm",attrs:{"post":item}})],1)}),0):_vm._e()],2)]),_vm._ssrNode(" "),_vm._ssrNode("<section class=\"grey-section pt-10 pb-10\">","</section>",[_vm._ssrNode("<div class=\"container mt-4\">","</div>",[_vm._ssrNode("<h2 class=\"title title-center\">4 Columns</h2> "),(_vm.posts.length > 0)?_c('swiper-carousel',{staticClass:"swiper-theme",attrs:{"options":_vm.baseSlider9}},_vm._l((_vm.posts.slice(0,4)),function(item){return _c('div',{key:("post-4cols-" + (item.slug)),staticClass:"swiper-slide"},[_c('post-one',{staticClass:"post-sm",attrs:{"post":item,"showCalendar":false}})],1)}),0):_vm._e()],2)]),_vm._ssrNode(" "),_vm._ssrNode("<section class=\"mt-10 pt-4 pb-4 mb-10\">","</section>",[_vm._ssrNode("<div class=\"container\">","</div>",[_vm._ssrNode("<h2 class=\"title title-center\">On Image</h2> "),(_vm.posts.length > 0)?_c('swiper-carousel',{staticClass:"swiper-theme",attrs:{"options":_vm.baseSlider10}},_vm._l((_vm.posts.slice(0,3)),function(item){return _c('div',{key:("post-image-" + (item.slug)),staticClass:"swiper-slide"},[_c('post-four',{attrs:{"post":item}})],1)}),0):_vm._e()],2)]),_vm._ssrNode(" "),_vm._ssrNode("<section class=\"pt-10 pb-10 grey-section\">","</section>",[_vm._ssrNode("<div class=\"container mt-4\">","</div>",[_vm._ssrNode("<h2 class=\"title title-center\">Framed</h2> "),(_vm.posts.length > 0)?_c('swiper-carousel',{staticClass:"swiper-theme post-slider",attrs:{"options":_vm.baseSlider10}},_vm._l((_vm.posts.slice(0,3)),function(item){return _c('div',{key:("post-frame-" + (item.slug)),staticClass:"swiper-slide"},[_c('div',{staticClass:"blog-post"},[_c('post-one',{staticClass:"post-frame",attrs:{"post":item,"overlay-class":"","btn-class":"btn-primary btn-underline"}})],1)])}),0):_vm._e()],2)]),_vm._ssrNode(" "),_c('element-list',{staticClass:"bg-white"})],2)],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/elements/blog-posts.vue?vue&type=template&id=c4242b00&
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./components/elements/post/PostTwo.vue?vue&type=template&id=5091b9ba&
var PostTwovue_type_template_id_5091b9ba_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"post post-list overlay-dark",class:{'post-video': _vm.post.type === 'video'}},[_vm._ssrNode("<figure class=\"post-media\">","</figure>",[(_vm.post.type !== 'gallery')?_c('nuxt-link',{attrs:{"to":("/blog/single/" + (_vm.post.slug))}},[_c('img',{directives:[{name:"lazy",rawName:"v-lazy",value:(("" + _vm.baseUrl + (_vm.post.pictures[0].url))),expression:"`${baseUrl}${post.pictures[0].url}`"}],attrs:{"width":_vm.post.pictures[0].width,"height":_vm.post.pictures[0].height,"alt":"post"}})]):_vm._e(),_vm._ssrNode(" "),(_vm.post.type === 'gallery')?_c('swiper-carousel',{staticClass:"swiper-theme swiper-dot-inner swiper-dot-white",attrs:{"options":_vm.baseSlider11}},_vm._l((_vm.post.pictures),function(item){return _c('div',{key:"post-one-" + item.url,staticClass:"swiper-slide"},[_c('img',{directives:[{name:"lazy",rawName:"v-lazy",value:(("" + _vm.baseUrl + (item.url))),expression:"`${baseUrl}${item.url}`"}],attrs:{"width":item.width,"height":item.height,"alt":"post"}})])}),0):_vm._e(),_vm._ssrNode(" "+((_vm.post.type === 'video')?("<span class=\"video-play\"></span> <video width=\"380\"><source"+(_vm._ssrAttr("src",("" + _vm.baseUrl + (_vm.post.video.url))))+"></video>"):"<!---->")+" <div class=\"post-calendar\"><span class=\"post-day\">"+_vm._ssrEscape(_vm._s(_vm.date.getDate()))+"</span> <span class=\"post-month\">"+_vm._ssrEscape(_vm._s(new Intl.DateTimeFormat('en-Us', {month:'short'}).format(_vm.date)))+"</span></div>")],2),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"post-details\">","</div>",[_vm._ssrNode("<h4 class=\"post-title\">","</h4>",[_c('nuxt-link',{attrs:{"to":("/blog/single/" + (_vm.post.slug))}},[_vm._v(_vm._s(_vm.post.title))])],1),_vm._ssrNode(" <p class=\"post-content\">"+_vm._ssrEscape("\n\t\t\t"+_vm._s(_vm.post.content)+"\n\t\t")+"</p> "),_c('nuxt-link',{staticClass:"btn btn-outline btn-md btn-dark btn-rounded",attrs:{"to":("/blog/single/" + (_vm.post.slug))}},[_vm._v("Read More"),_c('i',{staticClass:"d-icon-arrow-right"})])],2)],2)}
var PostTwovue_type_template_id_5091b9ba_staticRenderFns = []


// CONCATENATED MODULE: ./components/elements/post/PostTwo.vue?vue&type=template&id=5091b9ba&
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib??vue-loader-options!./components/elements/post/PostTwo.vue?vue&type=script&lang=js&
//
//
//
//
...
/* harmony default export */ var PostTwovue_type_script_lang_js_ = ({
  components: {
...
// CONCATENATED MODULE: ./components/elements/post/PostTwo.vue?vue&type=script&lang=js&
 /* harmony default export */ var post_PostTwovue_type_script_lang_js_ = (PostTwovue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(1);

// CONCATENATED MODULE: ./components/elements/post/PostTwo.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  post_PostTwovue_type_script_lang_js_,
  PostTwovue_type_template_id_5091b9ba_render,
  PostTwovue_type_template_id_5091b9ba_staticRenderFns,
  false,
  null,
  null,
  "7484fb22"
...
/* harmony default export */ var PostTwo = (component.exports);
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./components/elements/post/PostThree.vue?vue&type=template&id=310b9580&
var PostThreevue_type_template_id_310b9580_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"post overlay-zoom",class:{'post-video': _vm.post.type === 'video'}},[_vm._ssrNode("<figure class=\"post-media\">","</figure>",[(_vm.post.type !== 'gallery' && !_vm.isOriginal)?_c('nuxt-link',{attrs:{"to":("/blog/single/" + (_vm.post.slug))}},[_c('img',{directives:[{name:"lazy",rawName:"v-lazy",value:(("" + _vm.baseUrl + (_vm.post.pictures[0].url))),expression:"`${baseUrl}${post.pictures[0].url}`"}],attrs:{"width":_vm.post.pictures[0].width,"height":_vm.post.pictures[0].height,"alt":"post"}})]):_vm._e(),_vm._ssrNode(" "),(_vm.post.type !== 'gallery' && _vm.isOriginal)?_c('nuxt-link',{attrs:{"to":("/blog/single/" + (_vm.post.slug))}},[_c('img',{directives:[{name:"lazy",rawName:"v-lazy",value:(("" + _vm.baseUrl + (_vm.post.large_pictures[0].url))),expression:"`${baseUrl}${post.large_pictures[0].url}`"}],attrs:{"width":_vm.post.large_pictures[0].width,"height":_vm.post.large_pictures[0].height,"alt":"post"}})]):_vm._e(),_vm._ssrNode(" "),(_vm.post.type === 'gallery')?_c('swiper-carousel',{staticClass:"swiper-theme swiper-dot-inner swiper-dot-white",attrs:{"options":_vm.baseSlider11}},_vm._l((_vm.post.pictures),function(item){return _c('div',{key:"post-one-" + item.url,staticClass:"swiper-slide"},[_c('img',{directives:[{name:"lazy",rawName:"v-lazy",value:(("" + _vm.baseUrl + (item.url))),expression:"`${baseUrl}${item.url}`"}],attrs:{"width":item.width,"height":item.height,"alt":"post"}})])}),0):_vm._e(),_vm._ssrNode(" "+((_vm.post.type === 'video')?("<span class=\"video-play\"></span> <video width=\"380\"><source"+(_vm._ssrAttr("src",("" + _vm.baseUrl + (_vm.post.video.url))))+"></video>"):"<!---->"))],2),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"post-details\">","</div>",[_vm._ssrNode("<div class=\"post-meta\">\n\t\t\tby <a href=\"javascript:;\" class=\"post-author\">"+_vm._ssrEscape(_vm._s(_vm.post.author))+"</a>\n\t\t\ton <a href=\"javascript:;\" class=\"post-date\">"+_vm._ssrEscape(_vm._s(_vm.date.toLocaleDateString( 'en-US', { year: 'numeric', month: 'short', day: "2-digit", timeZone: "UTC" } )))+"</a></div> "),_vm._ssrNode("<h4 class=\"post-title\">","</h4>",[_c('nuxt-link',{attrs:{"to":("/blog/single/" + (_vm.post.slug))}},[_vm._v(_vm._s(_vm.post.title))])],1),_vm._ssrNode(" "),_c('nuxt-link',{class:("btn btn-link " + _vm.btnClass),attrs:{"to":("/blog/single/" + (_vm.post.slug))}},[_vm._v("Read More"),_c('i',{staticClass:"d-icon-arrow-right"})])],2)],2)}
var PostThreevue_type_template_id_310b9580_staticRenderFns = []


// CONCATENATED MODULE: ./components/elements/post/PostThree.vue?vue&type=template&id=310b9580&

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib??vue-loader-options!./components/elements/post/PostThree.vue?vue&type=script&lang=js&
//
//
//
//
...
/* harmony default export */ var PostThreevue_type_script_lang_js_ = ({
  components: {
    SwiperCarousel: SwiperCarousel["a" /* default */]
  },
  props: {
...
// CONCATENATED MODULE: ./components/elements/post/PostThree.vue?vue&type=script&lang=js&
 /* harmony default export */ var post_PostThreevue_type_script_lang_js_ = (PostThreevue_type_script_lang_js_); 
// CONCATENATED MODULE: ./components/elements/post/PostThree.vue
...
var PostThree_component = Object(componentNormalizer["a" /* default */])(
  post_PostThreevue_type_script_lang_js_,
  PostThreevue_type_template_id_310b9580_render,
  PostThreevue_type_template_id_310b9580_staticRenderFns,
  false,
  null,
  null,
  "31b2b601"
...
/* harmony default export */ var PostThree = (PostThree_component.exports);
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/elements/blog-posts.vue?vue&type=script&lang=js&
//
//
//
//
...
/* harmony default export */ var blog_postsvue_type_script_lang_js_ = ({
  ...
  data: function () {
    return {
      ...
      baseSlider12: carousel["d" /* baseSlider12 */]
    };
  },
  mounted: function () {
    api["c" /* default */].get(`${api["a" /* baseUrl */]}/element`, {
      params: {
        is_product: false,
        is_post: true
      }
...
// CONCATENATED MODULE: ./pages/elements/blog-posts.vue?vue&type=script&lang=js&
 /* harmony default export */ var elements_blog_postsvue_type_script_lang_js_ = (blog_postsvue_type_script_lang_js_); 
// CONCATENATED MODULE: ./pages/elements/blog-posts.vue
...
var blog_posts_component = Object(componentNormalizer["a" /* default */])(
  elements_blog_postsvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var blog_posts = __webpack_exports__["default"] = (blog_posts_component.exports);
