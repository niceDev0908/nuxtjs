...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/elements/typography.vue?vue&type=template&id=10854c86&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('main',{staticClass:"main"},[_c('page-header',{attrs:{"subTitle":"Elements","title":"Element Typography","parentUrl":"/elements"}}),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"page-content\">","</div>",[_vm._ssrNode("<div class=\"container\"><section class=\"mt-10 pt-3\"><div class=\"title-wrapper\"><h2 class=\"title title-center mb-2\">Headers</h2> <p class=\"text-body text-center mb-2\">We provide some basic styling to header tags. For\n\t\t\t\t\t\texample,<br> you can see 6 header tags' different sizes.</p></div> <div class=\"row\"><div class=\"col-md-6\"><h1 class=\"text-uppercase mb-3\">Heading h1</h1> <p class=\"mb-6\">Nulla quis sem at nibh elementum imperdiet. Duis sagittis ipsum.\n\t\t\t\t\t\t\tPraesent mauris. Fusce nec tellus sed augue semper porta. Mauris massa. Vestibulum\n\t\t\t\t\t\t\tlacinia arcu eget </p> <h2 class=\"text-uppercase\">Heading h2</h2> <h3 class=\"text-uppercase\">Heading h3</h3> <h4 class=\"text-uppercase\">Heading h4</h4> <h5 class=\"text-uppercase\">Heading h5</h5> <h6 class=\"text-uppercase\">Heading h6</h6></div> <div class=\"col-md-6\"><h1 class=\"font-weight-bold mb-3\">Heading h1</h1> <p class=\"mb-6\">Nulla quis sem at nibh elementum imperdiet. Duis sagittis ipsum.\n\t\t\t\t\t\t\tPraesent mauris. Fusce nec tellus sed augue semper porta. Mauris massa. Vestibulum\n\t\t\t\t\t\t\tlacinia arcu eget </p> <h2 class=\"font-weight-bold\">Heading h2</h2> <h3 class=\"font-weight-bold\">Heading h3</h3> <h4 class=\"font-weight-bold\">Heading h4</h4> <h5 class=\"font-weight-bold\">Heading h5</h5> <h6 class=\"font-weight-bold\">Heading h6</h6></div></div></section> <section class=\"mt-8\"><h2 class=\"title title-center mb-4\">Description With List</h2> <div class=\"font-primary \"><p class=\"mb-3\">Nulla quis sem at nibh elementum imperdiet. Duis sagittis ipsum. Praesent\n\t\t\t\t\t\tmauris. Fusce nec tellus sed augue semper porta. Mauris massa. Vestibulum lacinia arcu\n\t\t\t\t\t\teget nulla. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per\n\t\t\t\t\t\tinceptos himenaeos. Curabitur sodales ligula in libero. Vestibulum lacinia arcu eget\n\t\t\t\t\t\tnulla. Class aptent taciti sociosqu </p> <div class=\"row\"><div class=\"col-md-6\"><ul class=\"list list-type-check mb-4\"><li>Praesent id enim sit amet.</li> <li>Tdio vulputate eleifend in in tortor. ellus massa.Dristique sitiismonec.\n\t\t\t\t\t\t\t\t</li> <li>Massa ristique sit amet condim vel, facilisis quimequistiqutiqu amet condim.\n\t\t\t\t\t\t\t\t</li> <li>Dilisis Facilisis quis sapien. Praesent id enim sit amet.</li></ul></div> <div class=\"col-md-6\"><ul class=\"list list-type-number mb-4\"><li>Praesent id enim sit amet.</li> <li>Tdio vulputate eleifend in in tortor. ellus massa.Dristique sitiismonec.\n\t\t\t\t\t\t\t\t</li> <li>Massa ristique sit amet condim vel, facilisis quimequistiqutiqu amet condim.\n\t\t\t\t\t\t\t\t</li> <li>Dilisis Facilisis quis sapien. Praesent id enim sit amet.</li></ul></div></div></div></section> <section class=\"mt-7\"><h2 class=\"title title-center mb-4\">Blockquotes</h2> <div class=\"row\"><div class=\"col-md-6\"><blockquote class=\"text-bd-left\"><p>Nulla quis sem at nibh elementum imperdiet. Duis sagittis ipsum. Praesent mauris.\n\t\t\t\t\t\t\t\tFusce nec tellus sed augue semper porta. Mauris massa. Vestibulum lacinia arcu\n\t\t\t\t\t\t\t\teget nulla. Class aptent taciti sociosqu ad litora torquent per conubia nostra,\n\t\t\t\t\t\t\t\tper inceptos </p></blockquote></div> <div class=\"col-md-6\"><blockquote class=\"text-bd-left\"><p>Nulla quis sem at nibh elementum imperdiet. Duis sagittis ipsum. Praesent mauris.\n\t\t\t\t\t\t\t\tFusce nec tellus sed augue semper porta. Mauris massa. Vestibulum lacinia arcu\n\t\t\t\t\t\t\t\teget nulla. Class aptent taciti sociosqu ad litora torquent per conubia nostra.\n\t\t\t\t\t\t\t</p></blockquote></div></div></section></div> "),_c('element-list',{staticClass:"mt-5"})],2)],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/elements/typography.vue?vue&type=template&id=10854c86&
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/elements/typography.vue?vue&type=script&lang=js&
//
//
//
//
...
// CONCATENATED MODULE: ./pages/elements/typography.vue?vue&type=script&lang=js&
 /* harmony default export */ var elements_typographyvue_type_script_lang_js_ = (typographyvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(1);

// CONCATENATED MODULE: ./pages/elements/typography.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  elements_typographyvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
