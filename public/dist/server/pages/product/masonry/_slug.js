...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/product/masonry/_slug.vue?vue&type=template&id=39f00a34&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('main',{staticClass:"main mt-6 single-product product-layout-masonry"},[(_vm.loaded)?_vm._ssrNode("<div class=\"page-content mb-10 pb-6\">","</div>",[(_vm.product)?_vm._ssrNode("<div class=\"container\">","</div>",[_vm._ssrNode("<div class=\"product product-single row mb-2\">","</div>",[_vm._ssrNode("<div class=\"col-md-6\">","</div>",[_c('media-three',{attrs:{"product":_vm.product}})],1),_vm._ssrNode(" "),_vm._ssrNode("<div sticky-container class=\"col-md-6\">","</div>",[_c('detail-three',{directives:[{name:"sticky",rawName:"v-sticky",value:(_vm.isSticky),expression:"isSticky"}],attrs:{"sticky-offset":"{top: 85}","product":_vm.product,"prev":_vm.prev,"next":_vm.next}})],1)],2),_vm._ssrNode(" "),_c('related-products',{staticClass:"pt-3 mt-10",attrs:{"products":_vm.related}})],2):_vm._e()]):[_vm._ssrNode("<div class=\"skeleton-body container mb-10\">","</div>",[_vm._ssrNode("<div class=\"row mb-2\"><div class=\"col-md-6 product-masonry-type\"><div class=\"skel-pro-gallery\"></div></div> <div class=\"col-md-6\"><div class=\"skel-pro-summary mt-4 mt-md-0\"></div> <div class=\"skel-pro-tabs\"></div></div></div> "),_vm._ssrNode("<section class=\"pt-3 mt-4\">","</section>",[_vm._ssrNode("<h2 class=\"title justify-content-center\">Related Products</h2> "),_c('swiper-carousel',{staticClass:"skel-carousel swiper-theme swiper-nav-full related-products-carousel",attrs:{"options":_vm.baseSlider17}},_vm._l(([1,2,3,4,5,6]),function(item){return _c('div',{key:'product-skel-' + item,staticClass:"swiper-slide product-loading-overlay"})}),0)],2)],2)]],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/product/masonry/_slug.vue?vue&type=template&id=39f00a34&
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./components/partials/product/media/MediaThree.vue?vue&type=template&id=7dbc998a&
var MediaThreevue_type_template_id_7dbc998a_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"product-gallery row"},[_vm._ssrNode("<figure class=\"product-image mb-4\">","</figure>",[_c('img',{directives:[{name:"lazy",rawName:"v-lazy",value:(("" + _vm.baseUrl + (_vm.product.large_pictures[0].url))),expression:"`${baseUrl}${product.large_pictures[0].url}`"}],attrs:{"alt":"product masonry image","width":_vm.product.large_pictures[0].width,"height":_vm.product.large_pictures[0].height}},[]),_vm._ssrNode(" <a href=\"javascript:;\" class=\"product-image-full\"><i class=\"d-icon-zoom\"></i></a>")],2),_vm._ssrNode(" "),_vm._l((_vm.product.large_pictures.slice(1, 5)),function(item,index){return _vm._ssrNode("<div"+(_vm._ssrClass(null,("thumb-pictures " + (( index + 1 ) % 4 < 2 ? 'col-sm-4' : 'col-sm-8'))))+">","</div>",[_vm._ssrNode("<figure class=\"product-image mb-4\">","</figure>",[_c('img',{directives:[{name:"lazy",rawName:"v-lazy",value:(("" + _vm.baseUrl + (item.url))),expression:"`${baseUrl}${item.url}`"}],attrs:{"alt":"product masonry image","width":item.width,"height":item.height}},[]),_vm._ssrNode(" <a href=\"javascript:;\" class=\"product-image-full\"><i class=\"d-icon-zoom\"></i></a>")],2)])}),_vm._ssrNode(" "),_c('light-box',{ref:"lightBox",attrs:{"media":_vm.lightBoxMedia,"show-light-box":false}}),_vm._ssrNode(" <div class=\"product-label-group d-block\">"+((_vm.product.is_new)?("<div class=\"product-label label-new\">New</div>"):"<!---->")+" "+((_vm.product.stock === '0')?("<div class=\"product-label label-stock\">Out</div>"):"<!---->")+" "+((_vm.product.is_top)?("<div class=\"product-label label-top\">Top</div>"):"<!---->")+" "+((_vm.product.discount > 0)?("<div class=\"product-label label-sale\">"+((_vm.product.variants.length > 0)?("Sale"):(_vm._ssrEscape("-"+_vm._s(_vm.product.discount)+"%")))+"</div>"):"<!---->")+"</div>")],2)}
var MediaThreevue_type_template_id_7dbc998a_staticRenderFns = []


// CONCATENATED MODULE: ./components/partials/product/media/MediaThree.vue?vue&type=template&id=7dbc998a&
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib??vue-loader-options!./components/partials/product/media/MediaThree.vue?vue&type=script&lang=js&
//
//
//
//
...
/* harmony default export */ var MediaThreevue_type_script_lang_js_ = ({
  components: {
  ...
  computed: {
    lightBoxMedia: function () {
      return this.product.large_pictures.slice(0, 5).reduce((acc, cur) => {
        return [...acc, {
...
// CONCATENATED MODULE: ./components/partials/product/media/MediaThree.vue?vue&type=script&lang=js&
 /* harmony default export */ var media_MediaThreevue_type_script_lang_js_ = (MediaThreevue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(1);

// CONCATENATED MODULE: ./components/partials/product/media/MediaThree.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  media_MediaThreevue_type_script_lang_js_,
  MediaThreevue_type_template_id_7dbc998a_render,
  MediaThreevue_type_template_id_7dbc998a_staticRenderFns,
  false,
  null,
  null,
  "43495483"
...
/* harmony default export */ var MediaThree = (component.exports);
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/product/masonry/_slug.vue?vue&type=script&lang=js&
//
//
//
//
...
// CONCATENATED MODULE: ./pages/product/masonry/_slug.vue?vue&type=script&lang=js&
 /* harmony default export */ var masonry_slugvue_type_script_lang_js_ = (_slugvue_type_script_lang_js_); 
// CONCATENATED MODULE: ./pages/product/masonry/_slug.vue
...
var _slug_component = Object(componentNormalizer["a" /* default */])(
  masonry_slugvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
