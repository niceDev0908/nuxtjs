...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/blog/mask/grid.vue?vue&type=template&id=59251ecc&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('main',{staticClass:"main skeleton-body"},[_vm._ssrNode("<nav class=\"breadcrumb-nav\">","</nav>",[_vm._ssrNode("<div class=\"container\">","</div>",[_vm._ssrNode("<ul class=\"breadcrumb\">","</ul>",[_vm._ssrNode("<li>","</li>",[_c('nuxt-link',{attrs:{"to":"/","title":"link to home"}},[_c('i',{staticClass:"d-icon-home"})])],1),_vm._ssrNode(" "),_vm._ssrNode("<li>","</li>",[_c('nuxt-link',{staticClass:"active",attrs:{"to":"/blog/classic"}},[_vm._v("Blog")])],1),_vm._ssrNode(" <li>Mask Grid</li>")],2)])]),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"page-content pb-10 mb-10\">","</div>",[_vm._ssrNode("<div class=\"container\">","</div>",[(_vm.counts)?_vm._ssrNode("<ul class=\"nav-filters filter-underline blog-filters justify-content-center\">","</ul>",_vm._l((_vm.filterList),function(item,index){return _vm._ssrNode("<li>","</li>",[_c('nuxt-link',{class:("nav-filter " + (_vm.category === item.slug || (_vm.category === undefined && item.slug === 'all' ) ? 'active' : '')),attrs:{"to":{path: '/blog/mask/grid', query: { category: item.slug } }}},[_vm._v(_vm._s(item.name)+"\n\t\t\t\t\t")]),_vm._ssrNode("<span>"+_vm._ssrEscape(_vm._s(_vm.counts[item.slug]))+"</span>")],2)}),0):_vm._e(),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"posts grid row grid grid-3cols mb-5\">","</div>",[(!_vm.loaded)?[_vm._ssrNode((_vm._ssrList((new Array(_vm.itemsPerPage).fill(1)),function(item,index){return ("<div class=\"skel-post\"></div>")})))]:[_vm._ssrNode(((_vm.posts && _vm.posts.length === 0)?("<div class=\"info-box with-icon\"><p class=\"mt-4\">No blogs were found matching your selection.</p></div>"):"<!---->")+" "),_vm._l((_vm.posts),function(post,index){return _vm._ssrNode("<div class=\"grid-item\">","</div>",[_c('post-four',{attrs:{"post":post,"showCalendar":false}})],1)})]],2),_vm._ssrNode(" "),(_vm.totalPage)?_c('pagination',{attrs:{"total-page":_vm.totalPage}}):_vm._e()],2)])],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/blog/mask/grid.vue?vue&type=template&id=59251ecc&
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/blog/mask/grid.vue?vue&type=script&lang=js&
//
//
//
//
...
// CONCATENATED MODULE: ./pages/blog/mask/grid.vue?vue&type=script&lang=js&
 /* harmony default export */ var mask_gridvue_type_script_lang_js_ = (gridvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(1);

// CONCATENATED MODULE: ./pages/blog/mask/grid.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  mask_gridvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
